...
const HomePage = () => {
  ...
  return (
    <div className="">
      <div>
        ...
        <div className="homepage-image w-full pt-[35vh] h-[100vh] text-center">
          <div className="w-[80%] flex items-center justify-center flex-col ">
            <h1
              className={`leading-[1.1em] mb-4 title-font text-[2.9rem] md:text-[4rem] lg:text-[6rem] transition-opacity transition-transform duration-3000 ease-in-out ${
                isVisible
      ...
      <div className="bg-[#333]  w-[100%]">
        <div className="h-[70vh]  bg-white grid center">
          <div className="grid gap-2 grid-cols-2 w-[80%] items-center justify-between">
            <div className="">
              <img src="image/cycle.png" className="w-[30rem]  " alt="" />
            </div>
            <div className="text-align ">
              <h1 className=" text-[3rem] ">CYCLE</h1>
              <p className="  ">
        ...
        <div className="h-[70vh] grid center bg-blue-500 overflow-hidden ">
          <div className="grid gap-2  grid-cols-2 w-[80%] items-center justify-between">
            ...
            <div className="text-align ">
              <h1 className="text-white text-[3rem] ">BOAT</h1>
        ...
        <div className=" grid center py-20 gap-20">
          ...
          <div className="grid gap-10  grid-cols-1 md:grid-cols-3 w-[80%] items-center justify-between">
            <div className="grid gap-5">
              <span className="bg-white text-[2rem] rounded-[100%] p-5">
                <SiMinutemailer />
              </span>
